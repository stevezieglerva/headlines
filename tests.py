...
#         self.assertEqual(results, expected)
    ...
    def test_get_top_gram__given_no_tie__then_highest_returned(self):
        # Arrange
        input = [
        ...
        # Assert
        self.assertEqual(results, (2, "hurricane ida"))
    ...
    def test_get_lead_headlines__given_google_headlines__then_best_returned(self):
        ...
        self.assertEqual(
            results,
            ['Hurricane Ida Reversed the Course of the Mississippi River', 'Hurricane Ida knocks out power in all of New Orleans | DW News', 'Gas prices dodge Hurricane Ida catastrophe'],
        )
